...
export default function ProjectDetail1() {
  ...
  // 페이지 진입 시 첫 번째 모달 자동 오픈
  useEffect(() => {
    setModals("EffectModal1");
    setActiveEffect("EffectModal1");
    setEffectOpen(true);
  }, []);
  ...
  const modalMapping: ModalMapping = {
    EffectModal1: { title: "마우스로 드래그 해보세요", EffectComponent: SnowEffect },
    EffectModal2: { title: "마우스로 드래그 해보세요", EffectComponent: WaveEffect },
    EffectModal3: { title: "마우스로 드래그 해보세요", EffectComponent: CloudEffect },
  };
            ...
            <div className="visual__wrap">
              ...
              <div className="thumb-buttons">
                <button className="thumb-button">
                  HYBE <span className="small">IM</span>
                </button>
                <button className="thumb-button">
                  <span className="red">K</span>
                  <span className="gray">Car</span>
                </button>
                <button className="thumb-button">
                  신세계 <br />
                  <span className="small">라이브쇼핑</span>
                </button>
                <button className="thumb-button">리콜중..</button>
                <button className="thumb-button">리콜중..</button>
              </div>
            </div>
          </article>
